...
<body>
	<div class="sidebar-menu">
	  	<nav class="navbar navbar-dark">
	    	...
	    	<div class="col-11 d-flex justify-content-center" style="color: black;">
	    		<h1> FerreApp > Reportes > Articulos sin Saldo</h1>
	    	</div>
	  	</nav>
	</div>
	<br>
	...
	<div class="col-lg-12 w-100 contenedorTabla">
		<table id="tablaReporte23" class="display nowrap" style="width:100%">
	        <thead>
	            <tr>
	                <th>Categoria</th>
					<th>Id Producto</th>
	...
	iniciarTablaReporte23(function () {

	});
    });


    function iniciarTablaReporte23(callback) {

        console.log("ingresa a la funcion iniciar tabla producto");
        $("#tablaReporte23").DataTable({
        "ajax": {
        "method": "POST",
        "url": "../Reportes/Reporte23SQL.php"
