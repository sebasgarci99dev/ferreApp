...
$(document).ready(function () {
	iniciarTablaCategorias(function () {
...
//FUnciona OK
function iniciarTablaCategorias(callback) {

	console.log("ingresa a la funcion iniciar tabla producto");
	$("#tablaCategorias").DataTable({
		"ajax": {
			"method": "POST",
			"url": "../../server/Clases/cargarCategoriaTabla.php"
...
function limpiarModalCategorias(callback) {
