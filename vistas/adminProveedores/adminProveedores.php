	...
	<div class="sidebar-menu">
	  	<nav class="navbar navbar-dark">
	    	...
	    	<div class="col-11 d-flex justify-content-center" style="color: black;">
	    		<h1> FerreApp > Admin. Proveedores</h1>
	    	</div>
	  	</nav>
	</div>
	<br>
	<div class="col-lg-12 col-12 d-flex flex-row-reverse">
		<button class="btn btn-lg btn-info" id="btnCrearProveedores" data-toggle="modal" data-target="#modalProveedores">Crear proveedor</button>
	</div>
	<br>
	<div class="col-lg-12 w-100 contenedorTabla">
		<table id="tablaProveedores" class="display table table-info table-striped dt-responsive nowrap" style="width:100%">
	        <thead>
	            <tr>
	            	<th>Id. Provee.</th>
	                <th>Ident.</th>
	  	...
	  	<div class="modal-dialog" role="document">
	    	<div class="modal-content">
	      		<div class="modal-header">
	        		<h5 class="modal-title tituloModalCrear" id="titulo">Crear Proveedores</h5>
	        		<h5 class="d-none modal-title tituloModalEditar" id="titulo">Editar Proveedor</h5>
	      		...
	      		<div class="modal-footer">
	        		...
	        		<button type="button" class="btn btn-info d-none" id="btnEditarProveedores">Editar proveedor</button>
	        		<button type="button" class="btn btn-info" id="btnRegistrarProveedores">Crear proveedor</button>
	      		</div>
	    	</div>
	  	</div>
	</div>
